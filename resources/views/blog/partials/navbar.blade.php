    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
            <a class="btn btn-sm btn-outline-secondary"
               href="{{route('blog.more')}}">{{ __('canvas::blog.buttons.learn') }}</a>
        </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item"
                           href="{{ route('canvas.post.index') }}">{{ __('canvas::blog.nav.user.posts') }}</a>
                        <a class="dropdown-item"
                           href="{{ route('canvas.tag.index') }}">{{ __('canvas::blog.nav.user.tags') }}</a>
                        <a class="dropdown-item"
                           href="{{ route('canvas.topic.index') }}">{{ __('canvas::blog.nav.user.topics') }}</a>
                        <a class="dropdown-item"
                           href="{{ route('canvas.index') }}">{{ __('canvas::blog.nav.user.stats') }}</a>
